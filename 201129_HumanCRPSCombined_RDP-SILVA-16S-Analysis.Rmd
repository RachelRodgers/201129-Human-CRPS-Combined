...
(good vs. bad) for both UniFrac and weighted UniFrac distance measures.
...
When looking at the pairwise distances between samples from good and bad households, 
the RDP and SILVA data shows significantly lower average distance between samples from good 
households compared to bad when using the weighted UniFrac distance measure.
