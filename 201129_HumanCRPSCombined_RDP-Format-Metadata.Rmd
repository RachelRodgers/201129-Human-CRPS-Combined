---
title: "201129_HumanCRPSCombined_Format-RDP-Metadata"
...
Code originally from 201129_Human_CRPS_Combined_FormatMetadata.R
...
### Generate RDP Metadata File for Demultiplexing
...
saveRDS(sampleDataModified, "../data/RDP/RDataObjects/sampleDataModified.RDS")
```
...
saveRDS(sampleDataFinal, "../data/RDP/RDataObjects/sampleDataFinal.RDS")
```
