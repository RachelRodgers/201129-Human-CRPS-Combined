...
physeqSubsetList <- list("HHC" = physeqHHC, "Good_Households" = physeqGood,
...
ratioPlotList <- pmap(.l = list(df = phylaAbdPivotList,
                                xVar = groupVars,
                                statMethod = c(rep("wilcox.test", 3),
                                               "kruskal.test")),
                      .f = MakeBoxPlot,
                      yVar = "ratio",
...
```{r save-alphaDivList$No_BB-for-Lara, eval=FALSE, include=FALSE}
